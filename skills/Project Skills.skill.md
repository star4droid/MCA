---
name: Project Skills
description: Comprehensive technical reference for inspecting, creating, modifying, and serializing MCA 3D projects, scene graph nodes (Block, Half Block / Slab, Step Block / Stairs, Plane, Ground, Camera, Light, Character), skeletal rigging, timelines, action blocks, keyframes, and animations.
---

# MCA Project & Scene Architecture Skill
